...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Xin chào <strong><?php echo e($user->display_name); ?></strong>,</p>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/activate/' . $user->activation_token)); ?>" class="button">Kích hoạt tài khoản ngay</a>
            </div>
            
            <p style="margin-top: 30px; font-size: 13px; color: #7a8099;">Nếu bạn không tạo tài khoản này, xin vui lòng bỏ qua email.</p>
        </div>
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> SimpleNote. All rights reserved.
        </div>
    </div>
</body>
</html><?php /**PATH D:\Web\Composer\SimpleNote\resources\views/emails/activation.blade.php ENDPATH**/ ?>