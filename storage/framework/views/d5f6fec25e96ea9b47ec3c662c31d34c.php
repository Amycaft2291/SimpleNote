                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(isset($labels)): ?>
                                ...
                                <label class="flex items-center gap-1.5 text-xs bg-black/5 px-2 py-1 rounded-lg cursor-pointer hover:bg-black/10 <?php echo e($userUI->content); ?>">
                                    <input type="checkbox" name="labels[]" value="<?php echo e($label->id); ?>" class="rounded border-slate-300 text-blue-600 shadow-sm focus:ring-blue-500">
                        ...
                        <div class="flex flex-wrap gap-2" id="editLabelsContainer">
                            <?php $__currentLoopData = $labels ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center gap-1.5 ...">
                                    <input type="checkbox" name="labels[]" value="<?php echo e($label->id); ?>" class="edit-label-cb ...">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Web\Composer\SimpleNote\resources\views/dashboard.blade.php ENDPATH**/ ?>