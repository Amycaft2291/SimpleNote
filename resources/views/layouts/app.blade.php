            ...
            <div class="mb-8">
                ...
                <div class="space-y-1">
                    <a href="{{ route('dashboard') }}" 
                       class="group flex items-center justify-between px-3 py-2.5 rounded-xl {{ !request('label') ? 'bg-primary/10 text-primary' : 'text-slate-700 dark:text-slate-300' }} hover:bg-slate-100 dark:hover:bg-slate-800 transition-all">
                        <div class="flex items-center gap-3">
            ...
            <div class="border-t border-slate-100 dark:border-slate-800 pt-4 mt-4">
                ...
                <div class="space-y-1">
                    @foreach($labels as $label)
                        <div class="group flex items-center justify-between px-3 py-2 rounded-xl {{ request('label') == $label->id ? 'bg-primary/10' : '' }} hover:bg-slate-100 dark:hover:bg-slate-800 transition-all">
                            
                            {{--lọc gchú--}}
                            <a href="{{ request('label') == $label->id ? route('dashboard') : route('dashboard', ['label' => $label->id]) }}" 
